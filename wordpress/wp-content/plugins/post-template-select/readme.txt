...
Contributors: munishsandy
Tags: post, posts, custom posts, template, select post template, select template, theme, custom post type, custom template, custom template for post, post-template, wp custom post template
...
1. How to make a Template File.
2. Template select View on edit post screen.
3. Settings.
