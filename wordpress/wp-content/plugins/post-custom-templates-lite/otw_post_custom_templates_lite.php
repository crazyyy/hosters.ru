...
otw_register_component( 'otw_content_sidebars', dirname( __FILE__ ).'/include/otw_components/otw_content_sidebars/', $otw_pctl_plugin_url.'include/otw_components/otw_content_sidebars/' );
